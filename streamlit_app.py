...
boost_start = st.sidebar.number_input("Boost Start Year", min_value=2025, max_value=2070, value=2026, step=1)
boost_end = st.sidebar.number_input("Boost End Year", min_value=2025, max_value=2075, value=2035, step=1)
